...
import MenuItemList from '../../../paginas/AdminPanel/MenuItems/MenuItemList';
 ...
 export const menuRoutes = (user) => [
  ...
  <Route key="edit" path="/admin/menu/edit" element={user && user.role === "ADMIN" ? <EditMenuItem /> : <Navigate to="/login" />} />,
  <Route key="delete" path="/admin/menu/delete" element={user && user.role === "ADMIN" ? <DeleteMenuItem /> : <Navigate to="/login" />} />,
